...
class Location {
  ...
  static List<Location> fetchAll() {
    return [
      ...
      Location(6, 'Learning', 'assets/images/knitting.png', [
        LocationFact('Knitting',
            'Follow a Youtube tutorial to practice simple knitting partterns'),
        // LocationFact('How to Get There',
        //     'Kyoto airport, with several terminals, is located 16 kilometres south of the city and is also known as Kyoto. Kyoto can also be reached by transport links from other regional airports.'),
      ]),
      Location(7, 'Exercising', 'assets/images/stretching.png', [
      ...
      Location(8, 'Exercising', 'assets/images/weight-training.png', [
      ...
      Location(9, 'Exercising', 'assets/images/dancing.png', [
